      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar"  style="margin-top: 40px;">
		  <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="http://localhost/basdat/sirima/lihat_kartu_ujian.php">Kartu Ujian</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin-top: 60px;">
			<h1 style="text-align: center;">Form Lihat Kartu Ujian</h1><br>
			
			 <form style="width:100%; text-align: center;" action="kartu_ujian.php" method="post" target="_self">
			  Id Pendaftaran :
			   <input type="text" name="id_pendaftaran" maxlength="10" required="required"/>
			  <br><br>
			  <input class="btn btn-primary" id="jenjang-submit" type="submit" name="submit" value="Lihat">
			</form>
